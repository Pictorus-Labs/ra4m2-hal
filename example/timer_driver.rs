...
fn main() -> ! {
    ...
    system_clk
        ...
        .set_pclkb_divider(ra4m2_hal::sysc::ClockDividers::Div8); // Each tick of the timer is at 24MHz
    ...
    ra4m2_hal::time_driver::init(peripheral.AGT0, 3_000_000); // Initialize the time driver with AGT0
